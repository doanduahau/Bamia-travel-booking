...
CORS_ALLOW_ALL_ORIGINS = True # Dùng cho development
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('DB_PASSWORD', 'travel_password'),
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'TravelBaMia <support@travelbamia.com>')
